...
function createHistoryList(trsnDate, trsnMode, trsnAmount, trsnCatagory, trsnReason) {
    transactionDate = `${trsnDate}`;
    let li = document.createElement('li');
    li.className = 'd-flex align-items-center flex-wrap border shadow';

    li.innerHTML = `
                    <div class="my-0 mx-2">
                        <img style="border-radius: 50%; box-shadow: 0 2px 5px 0 rgba(0,0,0,0.2)" src="./icons/Categorys/${trsnCatagory}.png">
                    </div>

                    <div class="flex-grow-1 d-flex flex-column align-items-start p-0 ps-2 mt-1">
                        <h1 class="h1 m-0 text-uppercase" style='font-size: 19px'> <b> ${trsnReason} </b> </h1>
                    ...
                    <div class="d-flex align-items-center m-0 mt-1">
                        <p style='font-size: 12px;' class="m-0 pe-1 pt-4">  ${transactionDate.substring(0, 15)} </p>
                    </div>`;
    UL.append(li);
    transactionDate = ``;
}
